			...
			<form action="/MusicShop/ManagerBrandServlet" method="post">
				<table width="95%">
					<tr>
						...
						<td><input type="text" class="sedang" name="tenThuongHieu"
							value="<%=brand.getBrandName()%>"><%=error%></td>
					</tr>
					<tr>
						<td style="float: right"><b>Mã danh mục:</b></td>
						<td><input type="text" class="sedang" name="maThuongHieu"
							value="<%=brand.getBrandID()%>"><%=error%></td>
					</tr>
					<tr>
						<td></td>
						<td><input type="hidden" name="command" value="update">
							<input type="hidden" name="brand_id"
							value="<%=request.getParameter("brand_id")%>"> <input
