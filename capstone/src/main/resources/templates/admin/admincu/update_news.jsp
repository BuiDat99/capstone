...
<body>
	...
	<div id="wrapper">
		...
		<div id="rightContent">
			...
			<form method="post" action="/MusicShop/InsertProductServletx"
				...
				<table width="95%">
					...
					<tr>
						...
						<td><input type="hidden" class="sedang" name="maSanPham">
						<%--<%=error%>--%></td>
					</tr>

					<tr>
						<td><b>Loại bài viết</b></td>
						<td>
							<div>
								<span></span> <select name="maloai">
									<%--       <%
							...
							</div> <input type="hidden" class="sedang" name="">
						<%--<%=error%>--%>
						</td>
					</tr>
					<tr>
						<td width="125px"><b>Tiêu đề bài viết</b></td>
					...
					<tr>
						<td width="125px"><b>Tác giả</b></td>
						<td><input type="text" class="sedang" name="tacgia">
						<%--error%>--%></td>
					</tr>
					<tr>
						<td><b>Hình bài viết</b></td>
						<td><input type="file" placeholder="images/tênhình.jpg"
							class="sedang" name="daidien">
						<%--error%>--%></td><
					</tr>
					...
					<tr>
						<td><b>Nội dung</b></td>
						<td><textarea type="text" class="ckeditor" placeholder=""
								name="editor-update"><%--error%>--%></textarea></td>
					</tr>
					<tr>
						<td></td>
						<td><input type="submit" class="button" value="Sửa bài viết">
							<input type="reset" class="button" value="Phục hồi"></td>
					</tr>
				</table>
			</form>
			<%--
