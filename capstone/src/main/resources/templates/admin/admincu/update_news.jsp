            ...
            <jsp:include page="menu.jsp"></jsp:include>
                ...
                <div id="rightContent">
                    ...
                    <form method="post" action="/MusicShop/InsertProductServletx" enctype="multipart/form-data">
                        ...
                        <tr><td><b>Nội dung</b></td><td><textarea type="text" class="ckeditor" placeholder="" name="editor-update"><%--error%>--%></textarea></td></tr>
                        <tr><td></td><td>

                                <input type="submit" class="button" value="Sửa bài viết">
